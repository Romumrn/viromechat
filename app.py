...
def _register_user(authenticator: stauth.Authenticate) -> None:
    """
    Minimal registration form: first name, last name, academic email
    (used as the login username — not domain-verified, just labelled),
    password, and a captcha (to keep bots from mass-creating accounts). No
    ...
    if not (first_name and last_name and email and password and entered_captcha):
